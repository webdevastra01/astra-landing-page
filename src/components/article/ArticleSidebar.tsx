...
export const ArticleSidebar: React.FC<ArticleSidebarProps> = ({ articles, currentId }) => {
          ...
          {articles.map((vertical) => (
            ...
            >
              ...
              <div className="sidebar-link-content">
                ...
                <span className="sidebar-link-tagline">{vertical.tagline}</span>
              </div>
              <ChevronRight size={16} className="sidebar-link-arrow" aria-hidden="true" />
            </button>
          ))}
        </nav>
